          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <Card 
                  key={index}
                  className={`p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br ${bgColors[index]} dark:from-card dark:to-card border-2 cursor-pointer`}
                  onClick={() => navigate(service.link)}
                >
                  <div className="space-y-4 text-center">
                    <div className={`h-16 w-16 mx-auto rounded-xl bg-gradient-to-br ${colors[index]} flex items-center justify-center shadow-lg`}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => (
                <div 
                  key={index}
                  className="flex items-start gap-4 p-6 bg-card rounded-lg shadow-soft hover:shadow-medium transition-all duration-300"
                >
